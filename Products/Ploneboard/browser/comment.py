...
class CommentView(CommentViewableView):
    ...
    def GetTimePost(self, comment):
        obj = comment.get('getObject','')
        objTime = obj.bobobase_modification_time()
        
        TimeObj = hora(int(objTime.strftime('%Y')),
                       int(objTime.strftime('%m')),
                       int(objTime.strftime('%d')),
                       int(objTime.strftime('%H')),
                       int(objTime.strftime('%M')),
                       int(objTime.strftime('%S')),
                       )
        TimeNow = hora.now()
        dif = TimeNow-TimeObj
